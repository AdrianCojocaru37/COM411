...
def new_movie(t):
  ...
  movie = {}
  movie['Title']= t
  #movie['Released']= input('What year it was released?\n')
...
def movie_search(database={}):
  print('Search by: Title, Genre of Actor?')
  opt = input()
  movie= {}
  if opt.lower()== 'title':
...
def imdb():
  ...
  while True:
    ...
    if option ==1:
      ...
      print(movie_print(movie_search(imdb)))

    
    elif option ==3:
      print(imdb)
    elif option == 4:
      print('You chose to find out the hightest rated movie\n This is the one')
...
run()
>>>>>>> f904cb26d8fcab7607c18adf07b37de46dc0ff36
